              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{businessData.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{businessData.phone}</p>
                  </div>
                </div>
                ...
                <Tabs defaultValue="active" className="w-full">
                  ...
                  <TabsContent value="confirmed" className="py-6 space-y-4">
                    <div className="flex justify-between items-center mb-4">
                      <div>
                        <h4 className="font-medium">Confirmed Reservations</h4>
                        <p className="text-sm text-gray-500">
