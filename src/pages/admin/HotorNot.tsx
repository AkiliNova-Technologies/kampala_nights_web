...
export function HotOrNotPage() {
  ...
  // Add this function to handle nomination
  const handleNominate = (contestants: Contestant[]) => {
    console.log("Nominating contestants:", contestants);
    // Handle nomination logic here
  };
                      ...
                      <div className="flex flex-wrap gap-2 items-center">
                        ...
                        {selectedContestants.length > 0 && (
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              onClick={() =>
                                handleNominate(selectedContestants)
                              }
